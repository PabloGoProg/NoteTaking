...
---
The main purpose of the Terraform language is declaring [resources](https://developer.hashicorp.com/terraform/language/resources).
...
### Elements of Terraform Language
...
- Blocks are containers for describing content -> Usually objects configurations (e.g. Resources).
	- They can have 0-N _labels_.
	- A _Body_ with n key-value pairs (arguments) and n nested blocks.
